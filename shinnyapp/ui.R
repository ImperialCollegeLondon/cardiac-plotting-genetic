...
extractNames2 <-c("Age","Sex F0/M1","BSA","SBP","Pulse rate","Smoking status","Alcohol drinker status","Asthma","Bronchitis", "Hypertension",
  ...
  navbarPage("Digital Heart",
             tabPanel("Home",
                      ...
                      wellPanel(h1("Introduction"),
                                HTML("<p><h4>The primary aim of the website is to support the visualisation of cardiac imaging phenotypes derived from UK Biobank cardiovascular magnetic resonance (CMR) images for over 23,000 subjects and to enable the exploration of their links to other non-imaging phenotypes that characterise the structure and function for the the left ventricle (LV).<br>"),
                      ...
                      mainPanel(HTML('<img src = "ic_ukbb.png" height = "65" width = "350">'),
                                shiny::hr(),
                                span("Feedback:  "),
                                a("Email ", href = "mailto:mthanaj@ic.ac.uk"),
                                span("| Website by Marjola Thanaj (Last updated: 16 Apr 2020)"),
                                br()
                      )),
